def csv_to_excel_Publisher( file_full_path, time_from, time_to )
    ...
    worksheet_set_name(worksheet_obj,"Publisher")
...
#    point(left, top) + ":" + point(right,bottom)
    ...
    chart_set_source_data_2col(chart_obj,worksheet_obj, range(1,1,1,col_num), range(3,1,3,col_num), range(5,1,6,col_num))
    chart_set_title(chart_obj,"Publisher")
    ...
    chart_export(chart_obj,file_full_path.gsub(/\.csv$/,"Publisher.png")) # save chart as png file
