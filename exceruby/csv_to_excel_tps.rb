...
def csv_to_excel_tps( file_full_path, time_from, time_to )
    ...
    worksheet_set_name(worksheet_obj,"TPS")
    ...
    chart_set_source_data(chart_obj,worksheet_obj, range(1,1,1,col_num), range(2,1,2,col_num))     #select free column

    chart_set_axes_min(chart_obj,0)

    chart_set_title(chart_obj,"TPS")
