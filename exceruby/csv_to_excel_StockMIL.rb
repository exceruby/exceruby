def csv_to_excel_StockMIL( file_full_path, time_from, time_to )
    ...
    worksheet_set_name(worksheet_obj,"StockMIL")
...
#    point(left, top) + ":" + point(right,bottom)
    ...
    chart_set_title(chart_obj,"StockMIL")
    ...
    chart_export(chart_obj,file_full_path.gsub(/\.csv$/,"StockMIL.png")) # save chart as png file
